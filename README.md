...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,278 | 🐛 104 | 🌐 JavaScript | 📅 2026-07-03 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,278 | 🐛 104 | 🌐 JavaScript | 📅 2026-07-03 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,053 | 🐛 146 | 🌐 JavaScript | 📅 2026-07-26 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 15,925 | 🐛 242 | 🌐 TypeScript | 📅 2026-09-08 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 687 | 🐛 70 | 🌐 JavaScript | 📅 2026-09-08 is a community-maintained extension of Ramda.
...
* [fpEs](https://github.com/TeaEntityLab/fpEs/) ⭐ 43 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-07 - A small library provides simple usages of basic FP & pattern-matching/sumtype & MonadIO/Rx & Optional for Javascript. -TS.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,033 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-03 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,982 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-05 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,238 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,707 | 🐛 83 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,033 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-03.
...
* [functional-frontend-architecture](https://github.com/paldepind/functional-frontend-architecture) ⭐ 1,436 | 🐛 9 | 🌐 JavaScript | 📅 2019-07-02 – A functional frontend framework. Based on Ramda + union-type-js + Flyd + Snabbdom
