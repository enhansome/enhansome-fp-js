...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,321 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,321 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,059 | 🐛 146 | 🌐 JavaScript | 📅 2026-07-26 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 15,266 | 🐛 226 | 🌐 TypeScript | 📅 2026-08-13 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,121 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-10 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
...
* [Rambda](https://github.com/selfrefactor/rambda) ⭐ 1,755 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-13 - A faster alternative to Ramda in under 10kB.
* [js-joda](https://github.com/js-joda/js-joda) ⭐ 1,662 | 🐛 11 | 🌐 JavaScript | 📅 2026-07-20 – An immutable date and time library that provides a simple, domain-driven and clean API based on the ISO8601 calendar.
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,354 | 🐛 15 | 🌐 TypeScript | 📅 2026-06-27 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
* [fxts](https://github.com/marpple/FxTS) ⭐ 1,165 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-08 - Lazy evaluation and concurrency. +TS
...
* [1-liners](https://github.com/1-liners/1-liners) ⭐ 799 | 🐛 28 | 🌐 JavaScript | 📅 2023-04-16 – Functional tools that couldn’t be simpler. A dead simple functional utility belt, hand-crafted with love and attention.  -TS.
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 687 | 🐛 68 | 🌐 JavaScript | 📅 2026-08-11 is a community-maintained extension of Ramda.
...
* [react-on-lambda](https://github.com/sultan99/react-on-lambda) ⭐ 264 | 🐛 3 | 🌐 JavaScript | 📅 2024-05-08 - Replace JSX in React with functions (currying, compositions and etc).
...
* [functional.js](https://github.com/functionaljs/functional-js) ⭐ 223 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-27 – A lightweight functional JavaScript library that facilitates currying and point-free / tacit programming.
...
* [Ditox.js](https://github.com/mnasyrov/ditox) ⭐ 102 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-26 - Powerful dependency injection container for building modular apps. +TS
...
* [fpEs](https://github.com/TeaEntityLab/fpEs/) ⭐ 43 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-10 - A small library provides simple usages of basic FP & pattern-matching/sumtype & MonadIO/Rx & Optional for Javascript. -TS.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,045 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-06 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,979 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-11 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
* [Lazy.js](https://github.com/dtao/lazy.js) ⭐ 5,967 | 🐛 59 | 🌐 JavaScript | 📅 2020-07-15 – A utility library with a lazy engine under the hood that strives to do as little work as possible while being as flexible as possible.
...
* [Baobab](https://github.com/Yomguithereal/baobab) ⭐ 3,156 | 🐛 49 | 🌐 JavaScript | 📅 2022-05-10 – persistent and optionally immutable data tree with cursors.
* [List](https://github.com/funkia/list) ⭐ 1,653 | 🐛 22 | 🌐 TypeScript | 📅 2024-01-15 - An extremely fast immutable list with a comprehensive functional API. Designed to [seamlessly integrate with Ramda](https://github.com/funkia/list#seamless-ramda-integration) ⭐ 1,653 | 🐛 22 | 🌐 TypeScript | 📅 2024-01-15.
...
* [prelude.ts](https://github.com/emmanueltouzery/prelude.ts) ⭐ 385 | 🐛 16 | 🌐 TypeScript | 📅 2024-03-12 - Immutable persistent collections, functional constructs such as Option and Either, and combinators. Implemented in Typescript but supports javascript too.  +CT, +TS.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,241 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,671 | 🐛 82 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [purify](https://github.com/gigobyte/purify) ⭐ 1,602 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-16 - Functional programming library for TypeScript focusing on ADTs.  +CT, +TS.
* [crocks](https://github.com/evilsoft/crocks) ⭐ 1,598 | 🐛 69 | 🌐 JavaScript | 📅 2023-01-06 – A collection of popular Algebraic Data Types with the main goal to curate and provide not only a common interface between each type, but also all of the helper functions needed to hit the ground running. -TS.
...
* [daggy](https://github.com/puffnfresh/daggy) ⭐ 708 | 🐛 2 | 🌐 JavaScript | 📅 2021-07-19 – Library for creating tagged constructors.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,045 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-06.
...
* [partial.lenses](https://github.com/calmm-js/partial.lenses) ⭐ 922 | 🐛 23 | 🌐 JavaScript | 📅 2021-11-18 – Partial lenses is a comprehensive, high-performance optics library for JavaScript.
...
* [lenses](https://github.com/DrBoolean/lenses) ⭐ 216 | 🐛 3 | 🌐 JavaScript | 📅 2015-09-28 – Composable [kmett](https://github.com/ekmett/lens) ⭐ 2,099 | 🐛 91 | 🌐 Haskell | 📅 2026-08-13 style lenses.
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,390 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
* [GHCJS](https://github.com/ghcjs/ghcjs) ⭐ 2,620 | 🐛 292 | 🌐 Haskell | 📅 2023-01-21 – [Haskell](https://www.haskell.org/) to JavaScript compiler, based on GHC.
* [ElixirScript](https://github.com/bryanjos/elixirscript) ⭐ 1,564 | 🐛 19 | 🌐 Elixir | 📅 2019-08-20 – Compiles a subset of [Elixir](http://elixir-lang.org/), a dynamic, functional language designed for building scalable and maintainable applications, to JavaScript.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,646 | 🐛 27 | 📅 2023-10-17 – Jargon from the functional programming world explained in JavaScript.
...
* [cube-composer](https://github.com/sharkdp/cube-composer) ⭐ 2,045 | 🐛 10 | 🌐 PureScript | 📅 2022-12-08 – A puzzle game inspired by functional programming.
* [functional-javascript-workshop](https://github.com/timoxley/functional-javascript-workshop) ⭐ 2,040 | 🐛 83 | 🌐 JavaScript | 📅 2020-10-08 – The goal of this workshop is to create realistic problems that can be solved using terse, vanilla, idiomatic JavaScript to teach fundamental functional programming features of JavaScript.
* [functional-frontend-architecture](https://github.com/paldepind/functional-frontend-architecture) ⭐ 1,437 | 🐛 9 | 🌐 JavaScript | 📅 2019-07-02 – A functional frontend framework. Based on Ramda + union-type-js + Flyd + Snabbdom
...
* [xgrommx/Awesome Functional Programming](https://github.com/xgrommx/awesome-functional-programming) ⭐ 3,533 | 🐛 13 | 📅 2024-01-16 – A ton of articles on functional programming, as well as a huge list of functional libraries for many programming languages.
