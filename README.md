...
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 15,447 | 🐛 228 | 🌐 TypeScript | 📅 2026-08-22 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,131 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-10 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
...
* [js-joda](https://github.com/js-joda/js-joda) ⭐ 1,663 | 🐛 11 | 🌐 JavaScript | 📅 2026-07-20 – An immutable date and time library that provides a simple, domain-driven and clean API based on the ISO8601 calendar.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,041 | 🐛 128 | 🌐 TypeScript | 📅 2026-08-17 – Immutable persistent data collections.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,041 | 🐛 128 | 🌐 TypeScript | 📅 2026-08-17.
