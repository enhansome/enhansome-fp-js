...
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,048 | 🐛 148 | 🌐 JavaScript | 📅 2026-07-26 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 16,023 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-13 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [Rambda](https://github.com/selfrefactor/rambda) ⭐ 1,756 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - A faster alternative to Ramda in under 10kB.
...
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,980 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-12 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,648 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-12 – Jargon from the functional programming world explained in JavaScript.
