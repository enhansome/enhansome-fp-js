...
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 16,165 | 🐛 268 | 🌐 TypeScript | 📅 2026-09-22 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,714 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-14 – Jargon from the functional programming world explained in JavaScript.
