...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,280 | 🐛 105 | 🌐 JavaScript | 📅 2026-09-09 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,280 | 🐛 105 | 🌐 JavaScript | 📅 2026-09-09 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,053 | 🐛 147 | 🌐 JavaScript | 📅 2026-07-26 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 15,946 | 🐛 246 | 🌐 TypeScript | 📅 2026-09-09 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,147 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-08 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
* [most](https://github.com/cujojs/most) ⭐ 3,490 | 🐛 50 | 🌐 JavaScript | 📅 2022-12-06 – Ultra-high performance reactive programming to help you compose asynchronous operations on streams of values and events without many of the hazards of side effects and mutable shared state.
* [Rambda](https://github.com/selfrefactor/rambda) ⭐ 1,755 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - A faster alternative to Ramda in under 10kB.
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,363 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-08 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
* [fxts](https://github.com/marpple/FxTS) ⭐ 1,166 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-29 - Lazy evaluation and concurrency. +TS
...
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 687 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-08 is a community-maintained extension of Ramda.
...
* [lfi](https://github.com/TomerAberbach/lfi) ⭐ 348 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-16 - A Lazy Functional Iteration Library Supporting Sync, Async, and Concurrent Iteration.
...
* [rubico](https://github.com/a-synchronous/rubico) ⭐ 283 | 🐛 52 | 🌐 JavaScript | 📅 2026-07-31 - 🏞 \[a]synchronous functional syntax
...
* [TGrid](https://github.com/samchon/tgrid) ⭐ 167 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-18 - Grid Computing Framework, Network & Thread extension of [TSTL](https://github.com/samchon/tstl) ⭐ 631 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-22, supporting RFC (Remote Function Call). +TS.
...
* [barely-functional](https://github.com/cullophid/barely-functional) ⭐ 105 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-26 – A tiny (2.7kb) functional programming library using native ES5/6 operations. -TS.
* [Ditox.js](https://github.com/mnasyrov/ditox) ⭐ 103 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-26 - Powerful dependency injection container for building modular apps. +TS
* [preludejs](https://github.com/alanrsoares/prelude-js) ⭐ 101 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-28 - Hardcore Functional Programming for JavaScript. -TS.
* [curry](https://github.com/thisables/curry) ⭐ 87 | 🐛 4 | 🌐 JavaScript | 📅 2019-11-07 – Curry your functions using function bind syntax.
* [fp-filters](https://github.com/Oaxoa/fp-filters) ⭐ 87 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-11 - A curated collection of 130+ common-use filter functions.
...
* [zen-signals](https://github.com/joaomilho/zen-signals) ⭐ 52 | 🐛 8 | 🌐 TypeScript | 📅 2023-01-06 – ☯ The simplest signal library possible
...
* [fpEs](https://github.com/TeaEntityLab/fpEs/) ⭐ 43 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-09 - A small library provides simple usages of basic FP & pattern-matching/sumtype & MonadIO/Rx & Optional for Javascript. -TS.
...
* [tinyeffect](https://github.com/Snowflyt/tinyeffect) ⭐ 38 | 🐛 0 | 🌐 TypeScript | 📅 2025-03-30 - A tiny TypeScript library for handling side effects in a unified way using algebraic effects. +TS
...
* [rocket-pipes](https://github.com/darky/rocket-pipes) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Powerful pipes, that chain Promise and ADT like Maybe or Either from popular FP libraries. +TS
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,032 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-03 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,982 | 🐛 46 | 🌐 JavaScript | 📅 2026-09-08 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [List](https://github.com/funkia/list) ⭐ 1,650 | 🐛 22 | 🌐 TypeScript | 📅 2024-01-15 - An extremely fast immutable list with a comprehensive functional API. Designed to [seamlessly integrate with Ramda](https://github.com/funkia/list#seamless-ramda-integration) ⭐ 1,650 | 🐛 22 | 🌐 TypeScript | 📅 2024-01-15.
* [TSTL](https://github.com/samchon/tstl) ⭐ 631 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-22 - C++ STL (Standard Template Library) is implemented in TypeScript. STL Containers, iterators, algorithms and functors, that following functional programming rule, are provided. +TS.
* [DerivableJS](https://github.com/ds300/derivablejs) ⭐ 518 | 🐛 11 | 🌐 JavaScript | 📅 2018-05-26 – Functional Reactive State for JavaScript and TypeScript. DerivableJS enables you to make elegant declarative statements about how your bits of state are related. +TS.
...
* [prelude.ts](https://github.com/emmanueltouzery/prelude.ts) ⭐ 384 | 🐛 16 | 🌐 TypeScript | 📅 2024-03-12 - Immutable persistent collections, functional constructs such as Option and Either, and combinators. Implemented in Typescript but supports javascript too.  +CT, +TS.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,237 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,708 | 🐛 83 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
* [Sanctuary](https://github.com/plaid/sanctuary) ⭐ 3,051 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Sanctuary makes it possible to write safe code without null checks.  +CT, +TS.
...
* [purify](https://github.com/gigobyte/purify) ⭐ 1,605 | 🐛 3 | 🌐 TypeScript | 📅 2025-12-16 - Functional programming library for TypeScript focusing on ADTs.  +CT, +TS.
* [crocks](https://github.com/evilsoft/crocks) ⭐ 1,596 | 🐛 69 | 🌐 JavaScript | 📅 2023-01-06 – A collection of popular Algebraic Data Types with the main goal to curate and provide not only a common interface between each type, but also all of the helper functions needed to hit the ground running. -TS.
* [Static Land](https://github.com/rpominov/static-land) ⭐ 775 | 🐛 11 | 🌐 JavaScript | 📅 2019-10-29 – Specification similar to Fantasy Land but based on static methods rather than instance methods.
* [daggy](https://github.com/puffnfresh/daggy) ⭐ 707 | 🐛 2 | 🌐 JavaScript | 📅 2021-07-19 – Library for creating tagged constructors.
* [Pratica](https://github.com/rametta/pratica) ⭐ 490 | 🐛 0 | 🌐 TypeScript | 📅 2024-06-05 - Small, simple, easy FP data types for pragmatic and productive developers who need to ship reliable code fast.  +CT, +TS.
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,032 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-03.
...
* [sweet-monads](https://github.com/JSMonk/sweet-monads) ⭐ 355 | 🐛 13 | 🌐 TypeScript | 📅 2024-11-18 - A collection of popular monads (such as `Either` and `Maybe`) and the lazy iterator.
...
* [partial.lenses](https://github.com/calmm-js/partial.lenses) ⭐ 923 | 🐛 23 | 🌐 JavaScript | 📅 2021-11-18 – Partial lenses is a comprehensive, high-performance optics library for JavaScript.
...
* [lenses](https://github.com/DrBoolean/lenses) ⭐ 216 | 🐛 3 | 🌐 JavaScript | 📅 2015-09-28 – Composable [kmett](https://github.com/ekmett/lens) ⭐ 2,103 | 🐛 92 | 🌐 Haskell | 📅 2026-08-13 style lenses.
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,391 | 🐛 7 | 🌐 Clojure | 📅 2026-08-10 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
* [GHCJS](https://github.com/ghcjs/ghcjs) ⭐ 2,616 | 🐛 292 | 🌐 Haskell | 📅 2023-01-21 – [Haskell](https://www.haskell.org/) to JavaScript compiler, based on GHC.
...
* [eslint-plugin-fp](https://github.com/jfmengels/eslint-plugin-fp) ⭐ 968 | 🐛 31 | 🌐 JavaScript | 📅 2021-01-01 - ESLint rules for functional programming
* [hm-def](https://github.com/xodio/hm-def) ⭐ 204 | 🐛 13 | 🌐 JavaScript | 📅 2022-12-03 – Runtime type checking for JS with Hindley Milner signatures.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,648 | 🐛 27 | 📅 2023-10-17 – Jargon from the functional programming world explained in JavaScript.
* [You don't (may not) need loops ➿](https://github.com/you-dont-need/You-Dont-Need-Loops) ⭐ 1,174 | 🐛 5 | 📅 2024-10-15 - Loops are one of the first constructs that junior programmers learn, but they can pose many potential issues in the software development process, and could be avoided in many cases.
...
* [cube-composer](https://github.com/sharkdp/cube-composer) ⭐ 2,047 | 🐛 10 | 🌐 PureScript | 📅 2022-12-08 – A puzzle game inspired by functional programming.
* [functional-javascript-workshop](https://github.com/timoxley/functional-javascript-workshop) ⭐ 2,037 | 🐛 83 | 🌐 JavaScript | 📅 2020-10-08 – The goal of this workshop is to create realistic problems that can be solved using terse, vanilla, idiomatic JavaScript to teach fundamental functional programming features of JavaScript.
* [functional-frontend-architecture](https://github.com/paldepind/functional-frontend-architecture) ⭐ 1,434 | 🐛 9 | 🌐 JavaScript | 📅 2019-07-02 – A functional frontend framework. Based on Ramda + union-type-js + Flyd + Snabbdom
* [Escape from Callback Mountain](https://github.com/justsml/escape-from-callback-mountain) ⭐ 255 | 🐛 12 | 🌐 JavaScript | 📅 2023-02-24 - Design & refactoring tips for Promise-based Functional JavaScript. Key benefits include better readability, testability, and reusability. MIT.
...
* [xgrommx/Awesome Functional Programming](https://github.com/xgrommx/awesome-functional-programming) ⭐ 3,531 | 🐛 13 | 📅 2024-01-16 – A ton of articles on functional programming, as well as a huge list of functional libraries for many programming languages.
* [tk-learning-center/Functional Programming Learning Path](https://github.com/tk-learning-center/functional-programming-learning-path) ⭐ 1,042 | 🐛 1 | 🌐 Clojure | 📅 2024-10-22 - A Learning Path for Functional Programming
* [lucasviola/Awesome Functional Programming](https://github.com/lucasviola/awesome-functional-programming) ⭐ 1,009 | 🐛 1 | 📅 2024-04-22 – Awesome resources on functional programming theory and learning materials.
