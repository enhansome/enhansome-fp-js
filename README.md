...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,271 | 🐛 106 | 🌐 JavaScript | 📅 2026-09-11 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,271 | 🐛 106 | 🌐 JavaScript | 📅 2026-09-11 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
* [Ramda](https://github.com/ramda/ramda) ⭐ 24,051 | 🐛 144 | 🌐 JavaScript | 📅 2026-09-15 – A practical functional library for JavaScript that is designed specifically for a functional programming style. A style that makes it easy to create functional pipelines and never mutates user data. +TS.
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 16,145 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-20 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,166 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-11 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,366 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-10 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
...
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 687 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-17 is a community-maintained extension of Ramda.
...
* [TGrid](https://github.com/samchon/tgrid) ⭐ 167 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-20 - Grid Computing Framework, Network & Thread extension of [TSTL](https://github.com/samchon/tstl) ⭐ 630 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-22, supporting RFC (Remote Function Call). +TS.
...
* [fp-filters](https://github.com/Oaxoa/fp-filters) ⭐ 87 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-11 - A curated collection of 130+ common-use filter functions.
  ...
  tested. +TS
* [qio](https://github.com/tusharmath/qio) ⭐ 75 | 🐛 8 | 🌐 TypeScript | 📅 2022-08-16 – A type-safe, functional, performant, lawful, composable data structure that solves practical problems of effect-full code in node and browser. +TS
...
* [fpEs](https://github.com/TeaEntityLab/fpEs/) ⭐ 43 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-14 - A small library provides simple usages of basic FP & pattern-matching/sumtype & MonadIO/Rx & Optional for Javascript. -TS.
...
* [rocket-pipes](https://github.com/darky/rocket-pipes) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Powerful pipes, that chain Promise and ADT like Maybe or Either from popular FP libraries. +TS
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,030 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-10 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,979 | 🐛 53 | 🌐 JavaScript | 📅 2026-09-12 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [TSTL](https://github.com/samchon/tstl) ⭐ 630 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-22 - C++ STL (Standard Template Library) is implemented in TypeScript. STL Containers, iterators, algorithms and functors, that following functional programming rule, are provided. +TS.
...
* [collectable](https://github.com/frptools/collectable) ⭐ 281 | 🐛 39 | 🌐 TypeScript | 📅 2023-03-06 – Super high-performance immutable data structures for modern JavaScript and TypeScript applications. +TS.
...
* [NeverThrow](https://github.com/supermacro/neverthrow) ⭐ 7,720 | 🐛 83 | 🌐 TypeScript | 📅 2026-02-14 - This package contains a `Result` type that represents either success (`Ok`) or failure (`Err`).
...
* [purify](https://github.com/gigobyte/purify) ⭐ 1,607 | 🐛 3 | 🌐 TypeScript | 📅 2025-12-16 - Functional programming library for TypeScript focusing on ADTs.  +CT, +TS.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,030 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-10.
...
* [ClojureScript](https://github.com/clojure/clojurescript) ⭐ 9,391 | 🐛 8 | 🌐 Clojure | 📅 2026-09-20 – Compiles [Clojure](http://clojure.org/), a hosted Lisp with immutable persistent data structures, to JavaScript.
...
* [ElixirScript](https://github.com/bryanjos/elixirscript) ⭐ 1,565 | 🐛 23 | 🌐 Elixir | 📅 2019-08-20 – Compiles a subset of [Elixir](http://elixir-lang.org/), a dynamic, functional language designed for building scalable and maintainable applications, to JavaScript.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,708 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-14 – Jargon from the functional programming world explained in JavaScript.
...
* [lucasviola/Awesome Functional Programming](https://github.com/lucasviola/awesome-functional-programming) ⭐ 1,010 | 🐛 1 | 📅 2024-04-22 – Awesome resources on functional programming theory and learning materials.
