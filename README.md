...
* [lodash/fp](https://github.com/lodash/lodash/wiki/FP-Guide) ⭐ 61,326 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 – An instance of [Lodash](https://github.com/lodash/lodash) ⭐ 61,326 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 with its methods wrapped to produce immutable, auto-curried, iteratee-first, data-last methods. +TS.
...
* [effect-ts](https://github.com/Effect-TS/core) ⭐ 15,275 | 🐛 226 | 🌐 TypeScript | 📅 2026-08-14 – A Fully-fledged functional effect system for typescript with a rich standard library. +TS
* [ts-pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,123 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-10 - The exhaustive Pattern Matching library for TypeScript, with smart type inference. Pattern Matching is a code-branching technique coming from FP languages.
...
* [true-myth](https://github.com/true-myth/true-myth) ⭐ 1,356 | 🐛 15 | 🌐 TypeScript | 📅 2026-06-27 A library for safe, idiomatic null and error handling in TypeScript, with `Maybe` and `Result` types, supporting both a functional style and a more traditional method-call style
...
* [Ramda Adjunct](https://github.com/char0n/ramda-adjunct) ⭐ 687 | 🐛 68 | 🌐 JavaScript | 📅 2026-08-14 is a community-maintained extension of Ramda.
...
* [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,043 | 🐛 131 | 🌐 TypeScript | 📅 2026-08-14 – Immutable persistent data collections.
* [Immer](https://github.com/mweststrate/immer) ⭐ 28,978 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-11 – Immer is a tiny package for immutable state based on copy-on-write mechanism. +TS.
...
* [Fantasy Land](https://github.com/fantasyland/fantasy-land) ⭐ 10,242 | 🐛 36 | 🌐 JavaScript | 📅 2024-11-10 – Not a library, but a specification of the Monad laws for libraries to follow.
...
* [purify](https://github.com/gigobyte/purify) ⭐ 1,603 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-16 - Functional programming library for TypeScript focusing on ADTs.  +CT, +TS.
...
* [immutable-ext](https://github.com/DrBoolean/immutable-ext) ⭐ 489 | 🐛 5 | 🌐 JavaScript | 📅 2019-02-10 – FantasyLand extensions for [Immutable.js](https://github.com/facebook/immutable-js) ⭐ 33,043 | 🐛 131 | 🌐 TypeScript | 📅 2026-08-14.
...
* [Functional Programming Jargon](https://github.com/hemanth/functional-programming-jargon) ⭐ 18,645 | 🐛 27 | 📅 2023-10-17 – Jargon from the functional programming world explained in JavaScript.
